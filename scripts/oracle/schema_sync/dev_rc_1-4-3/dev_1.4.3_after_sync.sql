...
--------------------------------------------------------
 ...
 LOB ("value") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
...
--------------------------------------------------------
 ...
 LOB ("results") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) 
 LOB ("j5output") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
--  DDL for Table lock
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "PNY_DEV_1_4_3_DATA" 
 LOB ("masterDirectSynthesesList") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) 
 LOB ("masterOligoList") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) 
 LOB ("masterPlasmidList") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
--  DDL for Table part
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "PNY_DEV_1_4_3_DATA" 
 LOB ("sequence") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "PNY_DEV_1_4_3_DATA" 
 LOB ("htmlContent") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
--  DDL for Table role
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "PNY_DEV_1_4_3_DATA" 
 LOB ("userRestrictionEnzymeGroups") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_DATA" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "PNY_DEV_1_4_3_LOG" 
 LOB ("rawQuery") STORE AS SECUREFILE (
  TABLESPACE "PNY_DEV_1_4_3_LOG" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "PNY_DEV_1_4_3_DATA"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "PNY_DEV_1_4_3_LOG"  ENABLE;
--------------------------------------------------------
