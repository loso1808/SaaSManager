...
--------------------------------------------------------
  ...
  CREATE TABLE "user_logs" 
   (	"id" NUMBER DEFAULT "s_user_logs"."NEXTVAL", 
	"user_id" NUMBER, 
	"objectId" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "z_user_logs" 
   (	"logId" NUMBER DEFAULT "sz_user_logs"."NEXTVAL", 
...
--------------------------------------------------------
  ...
  USING INDEX ;
  ALTER TABLE "z_user_logs" MODIFY ("dateLogged" NOT NULL ENABLE);
  ALTER TABLE "z_user_logs" MODIFY ("logId" NOT NULL ENABLE);
