...
insert into "user" ("id","username","firstName","lastName", "password", "activated", "activeFlag") 
values (18, 'mikefero','Mike','Fero', '$2a$10$a3BOTytYHBko.I4aKpAPR.4b6Sr3s93mUH.UNwMyDGhdxo42sm.GW', 1, 1);
insert into "user" ("id","username","firstName","lastName", "password", "activated", "activeFlag") 
values (19, 'njhillson','Nathan','Hillson', '$2a$10$a3BOTytYHBko.I4aKpAPR.4b6Sr3s93mUH.UNwMyDGhdxo42sm.GW', 1, 1);
