...
cd /Users/rpavez/Sites/ve/EarlyAccessUpdated/update_${OLD}_to_${NEW}/01-runas_peony_owner/
...
cd ..
cd ..
cd /Users/rpavez/Sites/ve/EarlyAccessUpdated/update_${OLD}_to_${NEW}/02-runas_peony_app/
